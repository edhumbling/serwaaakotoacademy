...
const WhatsAppButton = ({ 
  ...
  return (
    <button 
      ...
      className={cn(
        'whatsapp-btn fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 rounded-full bg-green-500 shadow-lg hover:bg-green-600 transition-all duration-300', 
